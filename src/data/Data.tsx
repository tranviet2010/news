...
const categoriesData = [
  { title: 'Gíao dục', icon: 'assets/images/tl-12/sub-5.png' },
  { title: 'Công nghệ', icon: 'assets/images/tl-12/sub-3.png' },
  { title: 'Kinh doanh', icon: 'assets/images/tl-12/sub-7.png' },
  { title: 'Tiếng anh', icon: 'assets/images/tl-13/cate-4.png' },
  { title: 'Y dược', icon: 'assets/images/tl-13/cate-2.png' },
  { title: 'Truyền thông', icon: 'assets/images/tl-13/cate-1.png' },
  { title: 'Thiết kế', icon: 'assets/images/tl-12/sub-2.png' },
  { title: 'Khoa học', icon: 'assets/images/tl-12/sub-1.png' },
];
